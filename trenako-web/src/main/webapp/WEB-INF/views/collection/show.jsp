...
<html>
	<head>
		<title>
			<s:message code="collection.page.show.title"/>
		</title>
	...
	<body>
		<ul class="breadcrumb">
			...
			<li>
		  	...
		  	<li class="active">${owner.displayName}'s collection</li>
		</ul>
	
		<div class="row-fluid">
			<div class="page-header">
				<h1>${owner.displayName}'s collection <small>(<tk:evalValue type="Visibility" expression="${collection.visibility}"/>)</small></h1>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span10">
					...
					<form:form class="form-horizontal" method="PUT" action="${itemUrl}" modelAttribute="editForm">
						...
						<div class="modal-body">
							<div class="control-group">
  							...
  							<div class="control-group">
  								<form:label path="item.condition" class="control-label">Condition:&nbsp;&nbsp;</form:label>
  								<form:select path="item.condition">
  									<form:option value="">--conditions--</form:option>
				...
				<form:form class="form-horizontal" method="DELETE" action="${removeItemUrl}" modelAttribute="editForm">
					...
					<div id="removeItemModal" class="modal hide fade" tabindex="-1" role="dialog">
				  		...
				  		<div class="modal-body">
				    		<p>Are you sure to remove this item from your collection?</p>
				  		</div>
				  		<div class="modal-footer">
								...
								<div class="span9">
									...
									<p style="margin-top: 20px">
										<a href="#editItemDialog" class="btn btn-warning open-editItemDialog" role="button"
											...
											data-item-id="${item.itemId}">Edit this item</a>&nbsp;&nbsp;
