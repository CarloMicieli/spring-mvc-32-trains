...
@Controller
@RequestMapping("/rs")
public class RollingStockSearchController {
	
	private final RollingStockSearchService rsService;
	 ...
	 */
	@Autowired
	public RollingStockSearchController(RollingStockSearchService rsService) {
